# Exercício: Deixar +/- no PEP8. Sugestão: ?
...
def false_alarm_rate_score(tp, fp, fn, tn):
  return (fp)/(fp + tn)
...
# false_alarm_rate 
false_alarm_rate = false_alarm_rate_score(tp, fp, fn, tn)
print('false_alarm_rate: ', false_alarm_rate)
f.write('\nFAR: ')
f.write(str(false_alarm_rate))
